...
const Button: React.FC<ButtonProps> = ({label, children, liftHover, standardHover, sm, md, lg, outline, customStyle, transparent, selected, onClick}) => {
    const background = transparent ? 'bg:transparent text-white border-white border-2 hover:border-orange-600 duration-500' 
